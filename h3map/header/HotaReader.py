...
class HotaReader:
    ...
    def _read_metadata(self):
        ...
        return HotaMetadata(self.version, internal_version, any_players, height, two_level, name, desc, diff, max_level)
    ...
    def _read_internal_version(self):
        minor = self.parser.uint32()
        patch = self.parser.uint8()

        return str(minor) + str(patch)
